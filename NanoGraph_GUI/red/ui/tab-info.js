...
RED.sidebar.info = (function() {
	...
	$("#tab-info").html("<h3>Welcome</h3><p>The CMSIS System Design Tool lets you easily draw an ML/DSP system to process data streams.</p><p>Export will generate code that can be converted to a YAML graph description.</p><h3>Offline Use</h3><p>This tool does not use a server.  A stand-alone copy is provided in the gui folder.</p><h3>Credits</h3><p> Open source <a href=\"http://nodered.org/\" target=\"_blank\">Node-RED</a> project and <a href=\"https://www.pjrc.com/teensy/gui/\" target=\"_blank\">Teensy Audio</a> fork which this graph generator is based on </p>");
